...
BOOL InitD3D11(HINSTANCE hInstance) {
    ...
    {
        SimpleVertex(-0.5f, -0.5f, 0.5f, 1.0f, 0.0f, 0.0f, 1.0f), //bottom left
        SimpleVertex(-0.5f,  0.5f, 0.5f, 0.0f, 1.0f, 0.0f, 1.0f), //top left
        SimpleVertex(0.5f,  0.5f, 0.5f, 0.0f, 0.0f, 1.0f, 1.0f), //top right
        SimpleVertex(0.5f, -0.5f, 0.5f, 0.0f, 1.0f, 0.0f, 1.0f), //bottom right
    };
